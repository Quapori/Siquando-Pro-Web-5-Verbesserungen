...
<div class="sqrmainarea">
    ...
    <nav>
        ...
        <div class="sqrnavheader">
            ...
            <ul>
                ...
                {if isset($search)}
                    <li class="sqropensearch"><a href="#" data-srqnavmode="sqrnavmodesearch"><span>{$lang['search']->value}</span></a></li>
                {/if}
            </ul>
        ...
        {if isset($search)}
            <form class="sqrnavsearch" action="{$search|escape}"  >
        ...
        <div class="sqrnav">
            ...
            <ul class="sqrnavmain">
                ...
                <li{if $maintopic->objectUID===$topicuid} class="sqrnavactive"{/if}>
            ...
            <ul class="sqrnavmore">
                ...
                <li><a data-srqnavmode="sqrnavmodefull" href="#"><span>{$lang['menu']->value|escape}</span></a>
            </ul>
        </div>
                    ...
                    {if count($maintopic->children)>0}
                        <ul>
                            {foreach $maintopic->children as $topic}
                                <li{if $topic->objectUID===$topicuid} class="sqrnavactive"{/if}>
        ...
        {if isset($subtopics)}
            <ul class="sqrnavsubtopics">
                {foreach $subtopics as $subtopic}
                    <li{if $subtopic->objectUID===$topicuid} class="sqrnavactive"{/if}>
    ...
    {if isset($breadcrumbs)}
        <div class="sqrbreadcrumbs">
            {$lang['youarehere']->value|escape} {$breadcrumbs}
        </div>
    {/if}
