...
<div id="sqrmaincontainer">
    ...
    <nav class="sqrnav">
        ...
        {if isset ($logosource)}
            <a href="{$home->fullURL($previewMode)|escape}"><img class="sqrlogo" src="{$logosource|escape}" alt="" {if isset ($logosourcehd)} srcset="{$logosource|escape} 1x, {$logosourcehd|escape} 2x" {/if} /></a>
        {/if}
                ...
                <li{if $maintopic->objectUID===$topicuid} class="active"{/if}>
                    ...
                    {if count($maintopic->children)>0}
                        <div class="sqrnavcenter">
                            <div>
                                <ul>
                                    {if $navpictures1 && $maintopic->getPictureObject()!==null}
                                        <li>
                                            <a href="{$maintopic->fullURL($previewMode)|escape}">
                                                <figure>
                                                    <img src="{$maintopic->pictureSource(384,-1,$cropratio1)|escape}" alt="" width="{$maintopic->pictureSize(384,-1,$cropratio1)->width}" height="{$maintopic->pictureSize(384,-1,$cropratio1)->height}" />
                                                    <figcaption>
                                    ...
                                    {foreach $maintopic->children as $topic}
                                        <li>
                                            <a href="{$topic->fullURL($previewMode)|escape}">
                                                {if $navpictures2 && $topic->getPictureObject()!==null}
                                                <figure>
                                                    <img src="{$topic->pictureSource(384,-1,$cropratio2)|escape}" alt="" width="{$topic->pictureSize(384,-1,$cropratio2)->width}" height="{$topic->pictureSize(384,-1,$cropratio2)->height}" />
                                                    <figcaption>
                                                    ...
                                                    {foreach $topic->children as $subtopic}
                                                        <li>
                                                            <a href="{$subtopic->fullURL($previewMode)|escape}">
                                                                {if $navpictures3 && $subtopic->getPictureObject()!==null}
                                                                    <figure>
                                                                        <img src="{$subtopic->pictureSource(384,-1,$cropratio3)|escape}" alt="" width="{$subtopic->pictureSize(384,-1,$cropratio3)->width}" height="{$subtopic->pictureSize(384,-1,$cropratio3)->height}" />
                                                                        <figcaption>
                    ...
                    {if $page->pagecaption()!==''}
                        <div class="sqrallwaysboxed" >
                            {if (isset($breadcrumbs))}
                                <div id="sqrbreadcrumbs">{$lang['youarehere']->value} {$breadcrumbs}</div>
                            {/if}
