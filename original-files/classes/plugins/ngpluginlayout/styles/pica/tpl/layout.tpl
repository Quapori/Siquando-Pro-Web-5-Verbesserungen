...
<div class="sqrfixedcontainer">
    <div class="sqrtopcontainer">
        ...
        <nav class="sqrnav">
            ...
            <ul>
                {if $config['options.includehome']==='true'}
                <li class="sqrnavhome">
                    <a href="{$home->fullURL($previewMode)|escape}">
                        <span>{$home->caption|escape}</span>
                    </a>
                </li>
                {/if}
                            ...
                            <div>
                                <div>
                                    <ul>
                                        <li>
                                            <a href="{$maintopic->fullURL($previewMode)|escape}">
                                                <span>{$maintopic->caption|escape}</span>
                                            </a>
                                        </li>
...
<div class="sqroutercontainer">
    ...
    {if count($pictures)>0 || isset($eyecatchersource)}
        <header class="sqreyecatcher" data-autoprogress="{$autoprogress}">
            ...
            {if count($pictures)>1}
                <div class="sqreyecatcherbulletcontainer">{foreach $pictures as $picture}<a href="{$picture|escape}"><svg width="40" height="40" viewBox="0 0 40.00 40.00"><rect x="3" y="17" fill="#000000" fill-opacity="0.02" width="34" height="6"/><rect x="4" y="18" fill="#000000" fill-opacity="0.02" width="32" height="4"/><rect x="5" y="19" fill="currentColor" width="30" height="2"/></svg></a>{/foreach}</div>
            {/if}
        </header>
    {/if}
