...
class NGPluginLayoutProExt
{
    ...
    public function render()
    {
        ...
        $this->layout->javaScripts ['leonidas'] = NGUtil::prependRootPath('classes/plugins/ngpluginlayout/styles/leonidas/js/leonidas.js');
        ...
        $this->layout->createImage('logo', -1, 40, NGPicture::RatioNone);
        ...
        $this->layout->template->assign('size', $this->layout->settings->config ['options.size']);
