...
class NGPluginLayoutProExt
{
    ...
    public function render()
    {
        ...
        $this->layout->javaScripts ['cetera'] = NGUtil::prependRootPath('classes/plugins/ngpluginlayout/styles/cetera/js/cetera.js');
        ...
        $this->layout->createImage('logo', -1, 60, NGPicture::RatioNone);
        ...
        if (!$this->layout->topic->hideeyecatcher) {
            ...
            foreach ($bouquet->items as $item) {
                ...
                $pictures [] = NGLink::getPictureURL($item->displayPicture()->objectUID, $renderWidth - 2, -1, NGPicture::Ratio3by1);
            }
