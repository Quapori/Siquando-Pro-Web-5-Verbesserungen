...
class NGPluginLayoutProExt {
	...
	public function render() {
		...
		if (NGUtil::StringXMLToBool ( $this->layout->settings->config ['options.navactive'] )) {
		...
		$this->layout->javaScripts ['rhodeisland'] = NGUtil::prependRootPath ( 'classes/plugins/ngpluginlayout/styles/rhodeisland/js/navigation.js' );
        ...
        if (!$this->layout->topic->hideeyecatcher) $this->layout->createImage ( 'eyecatcher', 1920, 640, NGPicture::Ratio3by1 );
