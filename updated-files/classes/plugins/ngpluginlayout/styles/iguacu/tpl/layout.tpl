...
<div id="sqrouterbox">
    ...
    <div id="navcontainer">
        ...
        <div class="sqrnavbar">
            {if isset ($logosource)}
                <div id="sqrlogor" style="width:{$logoheight}px;height:{$logowidth}px">
                    <a href="{$home|escape}"><img src="{$logosource|escape}"
            ...
            {if isset($cartlink)}
                <a class="sqrcartlink" href="{$cartlink|escape}"><span class="ngshopcartindicator"></span></a>
            {/if}
            {if isset($accountlink)}
                <a class="sqraccountlink" href="{$accountlink|escape}"></a>
            {/if}
        </div>
        ...
        <div id="maincontainer">
            ...
            {if isset ($eyecatchersource)}
                <div id="sqreyecatcher">
                    <a href="{$home|escape}"><img src="{$eyecatchersource|escape}" alt=""/></a>
                </div>
            {/if}
            ...
            <footer class="sqrcommon">
                ...
                {if $config['contact.email']!=='' || $config['contact.facebook']!=='' || $config['contact.twitter']!=='' || $config['contact.linkedin']!=='' || $config['contact.xing']!=='' || $config['contact.instagram']!=='' || $config['contact.youtube']!=='' || $config['contact.pinterest']!==''}
                    <div class="sqrcontact">
                        ...
                        {if $config['contact.facebook']!==''}<a title="{$lang['facebook']->value|escape}"
                                                                target="_blank" href="{$config['contact.facebook']|escape}">
                                <svg width="24" height="24" viewBox="0 0 24.00 24.00">
                                    <path fill="currentColor"
                        ...
                        {if $config['contact.linkedin']!==''}<a title="{$lang['linkedin']->value|escape}"
                                                                target="_blank"
                        ...
                        {if $config['contact.instagram']!==''}<a title="{$lang['instagram']->value|escape}"
                                                                 target="_blank" href="{$config['contact.instagram']|escape}">
                                <svg width="24" height="24" viewBox="0 0 24.00 24.00">
                                    <path fill="currentColor"
                        ...
                        {if $config['contact.pinterest']!==''}<a title="{$lang['pinterest']->value|escape}"
                                                                 target="_blank" href="{$config['contact.pinterest']|escape}">
                                <svg width="24" height="24" viewBox="0 0 24.00 24.00">
                                    <path fill="currentColor"
