...
class NGPluginLayoutProExt {
	...
	public function render() {
		...
		$this->layout->javaScripts ['nyc'] = NGUtil::prependRootPath ( 'classes/plugins/ngpluginlayout/styles/nyc/js/navigation.js' );
		...
		$renderWidth = floor ( intval ( $this->layout->settings->config ['options.width'] ) * 0.75 );
		...
		$this->layout->createImage ( 'logo', - 1, 23, NGPicture::RatioNone );
		$this->layout->createImage ( 'eyecatcherq', 640, 640, NGPicture::Ratio1by1 );
		$this->layout->createImage ( 'eyecatcherw', 1920, 640, NGPicture::Ratio3by1 );
